...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx06bfd42845328475',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'db8fc5d87aa81d95e3d96a2d760a5096',
  ...
  USERS: [
    {
      ...
      id: '',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'osdom6NGU5V1PPdo1BFXagJTiYhE',
      // 所在省份
      province: '河北',
      // 所在城市
      city: '保定',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '2001', date: '04-18',
        },
        {
          type: '节日', name: '结婚纪念日', year: '2025', date: '05-20',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '老婆', year: '2001', date: '05-01',
        },
        {
          type: '节日', name: '被搭讪纪念日', year: '2022', date: '02-16',
        }
      ],
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'osdom6KDtTSqHVhMYBL_mstsrE0I',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {
      type: '*生日', name: '老婆', year: '2001', date: '04-18', isShowAge: true,
    },
    {
      type: '节日', name: '结婚纪念日', year: '2025', date: '05-20',
    },
