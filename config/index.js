export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx71d7dcdec1a23ac8",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c6f62135adb9a774b76025df753c704a",
  ...
  USERS: ["ooIhU6AGGb0Tk-qg0f9NE6HWeSSA"]
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "fywncgAQvku8dD7G9a2Y_v8dZx_7aFvsXblYU5fnhJ4",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "青岛",
      ...
      festivals: "type": "*生日", "name": "魏宝宝", "year": "2002", "date": "04-30",
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {"type": "*生日", "name": "魏宝宝", "year": "2002", "date": "04-30"},
