export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxe9c30a55925e370e",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "15373b0ac722480ad1e67ef2821e45ef",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "iEKPJmV7O76W4RyAbhO3LhYlFOS7lrLZcfK0nCCsHSI",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "枣庄",
      ...
      festivals: [
        ...
        {"type": "生日", "name": "微微宝贝", "year": "2000", "date": "09-02"},
    ...
    {
      name: "老婆1",
      id: "oMqH15l_3LzynNKdFq7myvGtZYDM",
      useTemplateId: "nfML2cEpuf-ztZcfoZYXUot1EnPzbAXuxgoW5bXy-Uw",
      province: "吉林",
      city: "吉林",
      horoscopeDate: '10-08',
      horoscopeDateType: '今日',
      openUrl: "https://wangxinleo.cn",
      festivals: [{"type": "生日", "name": "彤猪猪", "year": "2000", "date": "10-08"},
        {"type": "节日", "name": "超级无敌大帅哥", "year": "2001", "date": "03-03"},],
      customizedDateList: [{"keyword": "love_day", date: "2022-10-03"},{"keyword": "marry_day", date: "2022-10-03"},]
    },
    {
      name: "老婆2",
