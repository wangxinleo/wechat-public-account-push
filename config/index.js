export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx1554a564dba189f0",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "106e9b55e2c15148127569c5ec7de554",
   ...
   */
  USERS: [kilig-sano,emoi-zyc
    {
      // 想要发送的人的名字
      name: "哥哥",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "omZpU6HG6wwG-TPXlkliyABDxGC4",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "Oq0k_qXS8fWvJ9XJwq_wEacTCFb7RMQ-kT8j5VCvsLY",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "清远",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "1999", "date": "01-05"},
        {"type": "节日", "name": "纪念日", "year": "2022", "date": "07-11"},
