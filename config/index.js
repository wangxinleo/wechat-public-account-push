export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx66e0a40c53649c70",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "75aef43ae39ff276111cab87f3362053",
  ...
  USERS: [
    {
      ...
      id: "o-OVB5zJM6EvqqW_V1_ua42DVTfM",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "f4VtQZPjz08_TwZB3ibVUXgFWewzVQut1fGWePZiyB4",
      // 所在省份
      province: "福建",
      // 所在城市
      city: "厦门",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "灿灿", "year": "2004", "date": "02-07"},
        {"type": "*生日", "name": "俊俊", "year": "2004", "date": "05-12"},
        {"type": "节日", "name": "距离下一年", "year": "2022", "date": "01-01"},
