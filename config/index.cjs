...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx6c4ab40b2b1ef720',

  // 使用微信测试号时才需要填写：公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '816d1ee08672e677f76b4fb47d6e6c56',
  ...
  TIAN_API: {
    ...
    key: '2fefc98be22766514e8a9e751b2eb02c',
  ...
  USERS: [
    {
      ...
      id: 'o1eBAvvVNpPwTBzHPK3NNxSNgkFE',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      // 使用其他通道时，请填写 config/template-config.cjs 中某个想要使用的模板的id
      useTemplateId: 'NHgbP-CKrhRHhlTC4onj4kDkntA2shOpo4bThVx8dUA',
      // 所在省份或城市，也可以不填
      province: '贵州',
      // 所在城市或县区
      city: '贵阳',
  ...
  CALLBACK_TEMPLATE_ID: 'JchfPKb8Sw_WXOWVOK__ebY0X6GRZ4tpavUNdjq2F2k',
  ...
  CALLBACK_USERS: [
    {
      ...
      // 使用其他通道时，请严格按照各个通道的教程进行填写
      id: 'o1eBAvt0gvs6SQbbMz0Jr9HgdAOY',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
  ...
  FESTIVALS: [
    ...
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
    {
      type: '生日', name: '李四', year: '1996', date: '09-30', isShowAge: true,
    },
    {
      type: '节日', name: '被搭讪纪念日', year: '2021', date: '09-01',
    }
